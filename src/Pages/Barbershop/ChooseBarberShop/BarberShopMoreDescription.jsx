import { barberShopMoreDescriptionData ,popularServices } from "../../../assets/Dummydata/Dummydata"

function BarberShopMoreDescription() {
  return (
     <div
        ...
        >
          ...
          >
            <img
              ...
              src="https://d2zdpiztbgorvt.cloudfront.net/us/cms_content/6/63237122c8bb452492e56320726674b9.jpg"
              alt="booky hairsalon image"
            />
               
            {/* map hairsalon more Description dummyData */}
            {barberShopMoreDescriptionData.map(( item , i ) =>
                <div
                    key={i}
...
export default BarberShopMoreDescription
