  ...
  return (
    <main className="select-none">
      <div className="flex justify-between" onClick={handleshowProduct}>
        ...
        <span>
          {showProduct ? (
            <i className="fa-solid fa-chevron-up text-gray-600 cursor-pointer"></i>
          ) : (
            <i className="fa-solid fa-chevron-down text-gray-600 cursor-pointer"></i>
          )}
        </span>
      </div>
      {showProduct && (
      ...
      <div>
        <ul className="flex gap-5 flex-col md:flex-row md:justify-between flex-wrap md:gap-7">
          <li className="font-sans text-sm text-[gray] md:w-[40%]  ">
            <i className="fa-solid fa-shield-virus text-[#33b0c7]"></i>
          ...
          <li className="font-sans text-sm text-[gray] md:w-[40%] ">
            <i className="fa-solid fa-shield-virus text-[#33b0c7]"></i>
            {"   "} Client temperature checks
          </li>
          <li className="font-sans text-sm text-[gray] md:w-[40%] ">
            <i className="fa-solid fa-shield-virus text-[#33b0c7]"></i>
            {"   "} Employee temperature masks
          </li>
          <li className="font-sans text-sm text-[gray] md:w-[40%] ">
            <i className="fa-solid fa-shield-virus text-[#33b0c7]"></i>
