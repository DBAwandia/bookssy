        ...
        >
          ...
          >
            ...
            {hairSalonMoreDescriptionData.map(( item , i ) =>
                ...
                >
                    <h1
                    className="w-[90%] text-[1.5rem] font-[600] tracking-normal text-[#383734]"
                    >
                        {item.title}
                    </h1>
                ...
                >
                    <h1
                        className="w-[90%] pb-[1.5rem] text-[1.5rem] font-[600] tracking-normal text-[#383734]"
                    >
                        Articles
                    </h1>
                ...
                >
                   ...
                   >
                    {popularServices.map((item) =>
                            ...
                            >
                                <p
                                    className="w-auto px-[1.4rem] py-[0.5rem] rounded-2xl text-[#2a2d32] border-[0.6px] shadow-sm"
                                >
                                    {item.name}
                                </p>
                            </div>
